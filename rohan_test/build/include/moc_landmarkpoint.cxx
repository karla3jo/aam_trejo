...
void landmarkPoint::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData landmarkPoint::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject landmarkPoint::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_landmarkPoint,
      qt_meta_data_landmarkPoint, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &landmarkPoint::getStaticMetaObject() { return staticMetaObject; }

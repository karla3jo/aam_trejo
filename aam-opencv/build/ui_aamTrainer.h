...
**
** Created: Thu Jun 19 10:22:05 2014
...
public:
    ...
    void setupUi(QMainWindow *aamTrainer)
    {
        ...
        pb_capture->setGeometry(QRect(50, 270, 201, 31));
        ...
        lv_thumbnails->setGeometry(QRect(10, 310, 921, 311));
        ...
        landmarkImage->setGeometry(QRect(410, 20, 320, 240));
        ...
        pb_model->setGeometry(QRect(760, 40, 201, 41));
        ...
        pb_savemodel->setGeometry(QRect(760, 80, 201, 41));
        ...
        pb_delete->setGeometry(QRect(710, 630, 201, 41));
        ...
        pb_gendata->setGeometry(QRect(760, 120, 201, 41));
